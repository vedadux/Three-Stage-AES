...
const uint64_t AES_SBOX_TABLE[256] = {
...
const uint64_t A2X[8] = {0x98, 0xF3, 0xF2, 0x48, 0x09, 0x81, 0xA9, 0xFF};
const uint64_t X2A[8] = {0x64, 0x78, 0x6E, 0x8C, 0x68, 0x29, 0xDE, 0x60};
...
/// @brief Multiplies \c x and \c y in normal GF(16) basis (Z^4, Z)
/// @param x First multiplicand
/// @param y Second multiplicand
/// @return Product of multiplication
uint64_t gf_16_mul(uint64_t x, uint64_t y);

/// @brief Square a number in normal GF(4) basis (W^2, W). Same as inverse.
/// @param x Number to be squared
/// @return \c x ^2
uint64_t gf_4_sq(uint64_t x);

/// @brief Scale \c x by Sigma^2 = W in normal GF(4) basis (W^2, W)
/// @param x Number to be scaled
/// @return  \c x * Sigma^2
uint64_t gf_4_scl_sigma2(uint64_t x);

/// @brief Scale \c x by Sigma = W^2 in normal GF(4) basis (W^2, W)
/// @param x Number to be scaled
/// @return  \c x * Sigma
uint64_t gf_4_scl_sigma(uint64_t x);

/// @brief Multiplies \c x and \c y in normal GF(4) basis (W^2, W)
/// @param x First multiplicand
/// @param y Second multiplicand
/// @return Product of multiplication
